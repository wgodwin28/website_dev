---
title: "Geographic Distribution of Political Spending in U.S.-Pre and Post Midterm"
author: "Will Godwin"
date: "09/02/2019"
...
#rmarkdown::render(paste0("~/Desktop/google_ads/code/04_us_map_midterm.Rmd"))
#clear memory
rm(list=ls())
...
Upon seeing congressional district maps of political ad spending across the top states, I realized the aggregation across time was hiding important information regarding the motivation of the spending. Specifically, I wondered if the geographical spikes observed were solely due to midterm spending last November or to campaigns doling out cash for upcoming 2020 elections. Specifically, can we detect a different geographic distribution of spending for the 2020 campaigns compared to the lead up to the 2018 midterms? To answer this question, I split the spending data into 2 categories: pre-2018 midterms and post-2018 midterms, and then mapped the results.
